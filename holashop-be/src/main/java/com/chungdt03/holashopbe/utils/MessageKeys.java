package com.chungdt03.holashopbe.utils;
...
public class MessageKeys {
    ...
    // New keys for improved exception handling
    public static final String DUPLICATE_ENTRY = "error.duplicate_entry";
    public static final String TRANSACTION_ERROR = "error.transaction_error";
